...
export default {
    ...
    methods: {
        ...
        addLetters () {
            ...
            const svgURI = this.convertToURI(`<svg width='${100 * this.scale}px' height='${100 * this.scale}px' viewBox='0 0 ${4000} ${1000}' xmlns='http://www.w3.org/2000/svg'  transform='translate(${35 * this.scale}, ${30 * this.scale})' ><path d='${path.attributes.d.value}' transform='scale (1, -1)' style=' fill: ${this.primary}'></path></svg>`)
